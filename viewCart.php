								...
								<div class="banner-wrap">
									<div class="col-md-6 events-grid">
										...
										<div class="event-grid-bottom">
											...
											<div class="col-xs-9 event-grid-bottom-right">
												<h4><a href="#">We are living in a world today where lemonade is made from artificial flavors and furniture polish is made from real lemons
</a></h4>
												<p></p>
											</div>
											<div class="clearfix"> </div>
									...
									<div class="col-md-6 events-grid">
										...
										<div class="event-grid-bottom">
											...
											<div class="col-xs-9 event-grid-bottom-right">
												<h4><a href="#">Furniture should always be comfortable. And always have a piece of art that you made somewhere in the home.
</a></h4>
												<p></p>
